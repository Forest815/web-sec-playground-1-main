...
![メインページ](web-sec-playground-1-main/docs/main-page.png)
...
![アカウントロック画面](web-sec-playground-1-main/docs/account-lock.png)
...
![パスワード強度チェック](web-sec-playground-1-main/docs/password-strength.png)
